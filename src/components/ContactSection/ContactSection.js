    ...
    return (
        <section className="contact" id="contact">
            <div className={classes.root}>
                ...
                <p className={classes.templateBy}>• Portfolio Template by <span><a className={classes.developerLink} href="https://github.com/Ujjwal9025" target="_blank" rel="noopener noreferrer">Ujjwal Kumar</a></span> •</p>
                <Snackbar
                    ContentProps={{
                        classes: {
